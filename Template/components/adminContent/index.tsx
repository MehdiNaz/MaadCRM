...
import DashboardTopBar from '../dashboardContent/topBar'
import DashboardSidebar from './sidebar'
import '../dashboardContent/style.css'
import DashboardTitle from '../dashboardContent/title'
...
export default function AdminContent({ breadcrumbTitle, active_menu, children, actions = true, divider = true, header = true, hasAccess, token }: Dashboard) {
