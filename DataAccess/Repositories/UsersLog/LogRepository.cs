        ...
        try
        {
            return await _context.Logs
                ...
                .Select(x => new LogResponse
                {
                    ...
                    IdProductCategory = x.ProductCategoryId,
                    ProductCategoryName = x.ProductCategory.ProductCategoryName,
                    IdForoosh = x.ForooshId,
                    Type = x.Type,
                    IdUser = x.UserId,
        ...
        try
        {
            return await _context.Logs
                ...
                .Select(x => new LogResponse
                {
                    ...
                    UserAgent = x.UserAgent,
                    Description = x.Description
                }).FirstOrDefaultAsync(x => x.IdPeyGiry == peyGiryId);
        }
        catch (Exception e)
        {
            return new Result<LogResponse>(new ValidationException(e.Message));
        ...
        try
        {
            return await _context.Logs
                ...
                .Select(x => new LogResponse
                {
                    ...
                    UserAgent = x.UserAgent,
                    Description = x.Description
                }).FirstOrDefaultAsync(x => x.IdCustomer == customerId);
        }
        catch (Exception e)
        {
            return new Result<LogResponse>(new ValidationException(e.Message));
        ...
        try
        {
            return await _context.Logs
                ...
                .Select(x => new LogResponse
                {
                    ...
                    UserAgent = x.UserAgent,
                    Description = x.Description
                }).FirstOrDefaultAsync(x => x.IdProduct == productId);
        }
        catch (Exception e)
        {
            return new Result<LogResponse>(new ValidationException(e.Message));
        ...
        try
        {
            return await _context.Logs
                ...
                .Select(x => new LogResponse
                {
                    ...
                    UserAgent = x.UserAgent,
                    Description = x.Description
                }).FirstOrDefaultAsync(x => x.IdProductCategory == productCategoryId);
        }
        catch (Exception e)
        {
            return new Result<LogResponse>(new ValidationException(e.Message));
        ...
        try
        {
            return await _context.Logs
                ...
                .Select(x => new LogResponse
                {
                    ...
                    UserAgent = x.UserAgent,
                    Description = x.Description
                }).FirstOrDefaultAsync(x => x.IdForoosh == forooshId);
        }
        catch (Exception e)
        {
            return new Result<LogResponse>(new ValidationException(e.Message));
